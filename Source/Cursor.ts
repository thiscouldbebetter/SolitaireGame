...
class Cursor
{
	cardStackIndexSelected: number;
	numberOfCardsSelected: number;
	cardStackBeingMoved: CardStack;
	cardStackBeingMovedFrom: CardStack;
	...
	cardStackSelectNextInDirection
	(
		layout: Layout, directionSpecified: Coords
	): void
	{
	...
	cardStackSelectedTakeOrDrop(): void
	{
	...
	dropCardStackBeingMovedOntoOther(cardStackSelected: CardStack): void
	{
	...
	cardStackSelectedDeselect(): void
	{
		if (this.cardStackBeingMoved != null)
		{
	...
	cardStackSelectionCountAdd(offset: number): void
	{
		if
		(
